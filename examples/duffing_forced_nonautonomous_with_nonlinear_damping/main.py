...
duffing = DuffingForced_nonlin_Damping_SecondOrder(c=0.009, k=1.0, beta=1.0, alpha=0.05, P=1.0)  # Create an instance of Duffing
...
duffing_1st = DuffingForced_nonlin_Damping(c=0.009, k=1.0, beta=1.0, alpha=0.05, P=1.0)
...
solution_set_1st = duffing_solver_1st.solve_and_continue(
    ...
    step_length_adaptation_kwargs={"base": 2, "initial_step_length": 0.1, "maximum_step_length": 0.5,
